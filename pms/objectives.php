...
$sql=mysql_query("SELECT * FROM pms  where emp_id='$_SESSION[empid]' and month='$m1' AND MONTH(dates)=$m ");
...
<section id="two" class="wrapper style2">
    <div class="inner" style="background-color: white;width: 100%">
        <form method="post" action="scripts/validate_pms.php" id="objective">
...
<br><br>
        ...
        <button type="button" onclick="printJS({ printable: 'objective', type: 'html', header: 'PERFORMANCE MANAGEMENT SYSTEM' })">
            Print Form
        </button>
